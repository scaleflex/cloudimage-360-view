...
function Gi(e, t, i) {
  ...
  function u(f) {
    var C = s, x = o;
    return s = o = void 0, h = f, r = e.apply(x, C), r;
  }
  function I(f) {
    return h = f, a = setTimeout(y, t), c ? u(f) : r;
  }
  function g(f) {
    var C = f - l, x = f - h, P = t - C;
    return p ? Bi(P, n - x) : P;
  }
  function v(f) {
    var C = f - l, x = f - h;
    return l === void 0 || C >= t || C < 0 || p && x >= n;
  }
  function y() {
    var f = ie();
    if (v(f))
  ...
  function k(f) {
    return a = void 0, m && s ? u(f) : (s = o = void 0, r);
  }
  function b() {
    a !== void 0 && clearTimeout(a), h = 0, s = l = o = a = void 0;
  }
  function w() {
  ...
  function E() {
    var f = ie(), C = v(f);
    if (s = arguments, o = this, l = f, C) {
      if (a === void 0)
        return I(l);
      if (p)
        return a = setTimeout(y, t), u(l);
    }
    return a === void 0 && (a = setTimeout(y, t)), r;
  }
...
function _i(e, t, i) {
  ...
  if (typeof e != "function")
    throw new TypeError(Ke);
  return jt(i) && (s = "leading" in i ? !!i.leading : s, o = "trailing" in i ? !!i.trailing : o), Gi(e, t, {
    leading: s,
    maxWait: t,
    trailing: o
  });
...
function Ni(e) {
  return typeof e == "symbol" || Fi(e) && Zi.call(e) == Si;
}
function ye(e) {
  if (typeof e == "number")
    return e;
...
const be = /* @__PURE__ */ Ti(Wi), L = {
  ...
  X: "x-axis",
  Y: "y-axis"
}, ji = [37, 39], Ui = [38, 40], $i = typeof navigator < "u" && /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), we = $i ? 32 : 10, Ki = 150, qi = 150, Ji = 200, Ce = 50, Qi = 50, ts = 50, d = {
  folder: "/",
  apiVersion: "v7",
  ...
  if (!i && !e.folder && !e.imageListX && !e.imageListY && t.push("Either folder or imageListX/imageListY is required"), !i && e.folder && !e.amountX && !e.imageListX && t.push("amountX is required when using folder (unless imageListX is provided)"), e.filenameGrid && (!e.amountX || e.amountX <= 0 || !e.amountY || e.amountY <= 0) && t.push("filenameGrid requires both amountX > 0 and amountY > 0"), e.imageListGrid) {
    ...
    const o = Array.isArray(e.imageListGrid) ? e.imageListGrid.flat() : [];
    o.length && e.amountX && e.amountY && o.length !== e.amountX * e.amountY && t.push(`imageListGrid length (${o.length}) does not match amountX * amountY (${e.amountX * e.amountY})`);
  }
  const s = ["spin-x", "spin-y", "spin-xy", "spin-yx"];
  return e.autoplayBehavior && !s.includes(e.autoplayBehavior) && t.push(`autoplayBehavior should be one of: ${s.join(", ")}`), t.forEach((o) => {
  ...
  const o = T(e, t, null);
  return o !== "false" && o !== "0";
}, It = (e, t) => T(e, t, null) === "false", os = (e = 1) => {
  ...
  return `https://${t}.cloudimg.io/${i}${s}`;
}, Ie = (e, t) => e ? `ar=${e}&gravity=${t || "auto"}` : "", rs = ({ ciTransformation: e, responsiveWidth: t, ciFilters: i }) => {
  const s = `width=${t}`, o = e || s, n = i ? `&f=${i}` : "";
  return `${o}${n}`;
}, et = (e, t) => {
  const { folder: i, apiVersion: s, filename: o = "", ciParams: n } = e, { ciToken: r, ciFilters: a, ciTransformation: l, cropAspectRatio: h, cropGravity: c } = n || {}, p = `${i}${o}`;
  if (!r || !t) {
    const b = Ie(h, c);
    if (!b) return p;
    const w = p.includes("?") ? "&" : "?";
  ...
  const m = Vi.includes(s) ? null : s, u = m ? `${m}/` : "", I = os(t), g = ns(p, r, u), v = rs({
    ciTransformation: l,
    responsiveWidth: I,
    ciFilters: a
  }), y = Ie(h, c), k = [v, y].filter(Boolean).join("&");
  return `${g}${k ? "?" : ""}${k}`;
}, Ut = (e, t = 0) => (e += "", e.length >= t ? e : new Array(t - e.length + 1).join("0") + e), as = (e, { amount: t = 0, indexZeroBase: i = 0 } = {}) => Array.from({ length: t }, (s, o) => e.replace("{index}", Ut(o + 1, i))), ls = (e, { amountX: t = 0, amountY: i = 0, indexZeroBase: s = 0 } = {}) => {
  const o = [];
  for (let n = 0; n < i; n++)
    for (let r = 0; r < t; r++)
      o.push(
        e.replace("{indexX}", Ut(r + 1, s)).replace("{indexY}", Ut(n + 1, s))
      );
  return o;
}, hs = typeof navigator < "u" && /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), cs = hs ? 3 : 6, qe = ({
  imagesUrls: e,
  onFirstImageLoad: t,
  onImageLoad: i,
  onAllImagesLoad: s,
  ...
  const u = [], I = (f, C, x = !1) => {
    ...
    r === l && (s == null || s(h, { errorCount: a, errors: c }));
  }, v = () => {
    for (; p < cs && m < u.length; ) {
      const f = u[m];
      m++, y(e[f], f);
    ...
    x.crossOrigin = "anonymous", x.src = f, x.onload = async () => {
      try {
        const P = await createImageBitmap(x), S = {
          src: f,
          bitmapImage: P,
          naturalWidth: x.naturalWidth,
          naturalHeight: x.naturalHeight
        };
        x.onload = null, x.onerror = null, x.src = "", r++, p--, h[C] = S, i == null || i(S, C), g(), v();
      } catch {
        x.onload = null, x.onerror = null, x.src = "", r++, p--, I(f, C), g(), v();
      }
    }, x.onerror = () => {
      x.onload = null, x.onerror = null, x.src = "", r++, p--, I(f, C), g(), v();
    };
    ...
    for (let C = 0; C < e.length; C++)
      C !== f && u.push(C);
    m = 0, v();
  }, b = new Image(), w = n ? e.length - 1 : 0, E = e[w];
  b.crossOrigin = "anonymous", b.src = E, b.onload = async () => {
    try {
      const f = await createImageBitmap(b), C = {
        src: E,
        bitmapImage: f,
        naturalWidth: b.naturalWidth,
        naturalHeight: b.naturalHeight
      };
      b.onload = null, b.onerror = null, b.src = "", h[w] = C, r++, t == null || t(C), i == null || i(C, w), l === 1 ? g() : k(w);
    } catch {
      b.onload = null, b.onerror = null, b.src = "", r++, I(E, w, !0), l === 1 ? g() : k(w);
    }
  }, b.onerror = () => {
    b.onload = null, b.onerror = null, b.src = "", r++, I(E, w, !0), l === 1 ? g() : k(w);
  };
  ...
  }, v = ({ cdnPath: y, config: k, orientation: b, loadedImages: w, loadStats: E, onFirstImageLoad: f }) => {
    const C = b === O.X, x = k.imageList.length ? k.imageList : as(y, k);
    qe({
      imagesUrls: x,
      onFirstImageLoad: f,
      onImageLoad: (P, S) => {
        n == null || n(P, S, b), w[S] = P;
      },
      onError: (P) => {
        a == null || a({ ...P, orientation: b });
      },
      onAllImagesLoad: (P, S) => {
        w.length = 0, P.forEach((A, M) => {
          A && (w[M] = A);
        }), E.errorCount = S.errorCount, E.errors = S.errors.map((A) => ({ ...A, orientation: b })), l[C ? "x" : "y"] = !0, g();
      },
  ...
  const r = t.imageList && t.imageList.length ? t.imageList : ls(e, t);
  qe({
    imagesUrls: r,
    onFirstImageLoad: i,
    onImageLoad: (a, l) => {
...
`, us = (e) => {
  ...
  return t.innerHTML = ds, t.style.bottom = `${e}%`, t.className = "cloudimage-360-view-360-circle", t;
}, ps = `
...
`, Je = (e) => {
  const t = document.createElement("div");
  return t.className = "cloudimage-initial-icon", t.setAttribute("aria-label", "360 degree view - drag to rotate"), e ? (t.style.backgroundImage = `url('${e}')`, t.style.backgroundPosition = "50% 50%", t.style.backgroundSize = "contain", t.style.backgroundRepeat = "no-repeat") : t.innerHTML = ps, t;
}, ms = (e) => {
  const t = document.createElement("div");
  ...
  return s.className = "cloudimage-360-click-overlay-label", s.textContent = "Click to load 360° view", t.appendChild(i), t.appendChild(s), t;
}, fs = (e, t) => {
...
}, Qe = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="15 3 21 3 21 9"/><polyline points="9 21 3 21 3 15"/><line x1="21" x2="14" y1="3" y2="10"/><line x1="3" x2="10" y1="21" y2="14"/></svg>', gs = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="4 14 10 14 10 20"/><polyline points="20 10 14 10 14 4"/><line x1="14" x2="21" y1="10" y2="3"/><line x1="3" x2="10" y1="21" y2="14"/></svg>', vs = () => {
  ...
  e && (e.innerHTML = t ? gs : Qe, e.setAttribute("aria-label", t ? "Exit fullscreen" : "View fullscreen"));
}, Ee = (e) => {
  const t = document.createElement("div");
  ...
  return s.className = "cloudimage-360-hints-container", t.forEach((o) => {
    ti[o] && s.appendChild(Ps(o));
  }), i.appendChild(s), e.appendChild(i), i;
}, Te = (e, t) => t ? ["swipe", "pinch"] : ["drag", "dblclick"], Se = (e) => {
  ...
  if (o.style.left = `${n}%`, s) {
    ...
    r.className = "cloudimage-360-hotspot-timeline-tooltip", r.textContent = s, o.appendChild(r);
    let a = null;
  ...
  return r.className = "cloudimage-360-hotspot-timeline-indicator", s.forEach(({ id: a, frame: l, label: h }) => {
    const c = Ls(a, l, t, h);
    n.appendChild(c);
  }), n.appendChild(r), o.appendChild(n), e.appendChild(o), {
    element: o,
    indicator: r,
    hotspotFrames: s
  };
  ...
  const [i, s] = e.split("?");
  if (!s) return e;
  const o = new RegExp(`^${t}=|&${t}=`), n = s.split("&").filter((r) => !o.test(r)).join("&");
  return n ? `${i}?${n}` : i;
}, Rs = (e) => {
  const t = Hs(e, "width"), i = t.includes("?") ? "&" : "?";
  ...
  const { innerBox: s, imageList: o, lazyload: n } = t || {}, [r] = o, a = r || Ds(e, t), l = Rs(a), h = Xe(l, n, "cloudimage-lazy"), c = Xe(l, !1, "cloudimage-360-placeholder"), p = (m) => {
    Pt(s, ".cloudimage-lazy"), i && i({
      event: m,
      width: h.width,
      height: h.height,
  ...
  h.onload = p, s.appendChild(h), s.appendChild(c), zs(h);
}, Bs = (e, t, i) => {
  const s = e / i, o = t / i;
  ...
  let h = e / n * a - s / 2, c = t / r * l - o / 2;
  const p = Math.max(0, a - s), m = Math.max(0, l - o);
  return h = Math.max(0, Math.min(h, p)), c = Math.max(0, Math.min(c, m)), { zoomOffsetX: h, zoomOffsetY: c };
}, Le = (e, { bottom: t, top: i }) => {
  e ? t() : i();
}, Oe = (e, { left: t, right: i }) => {
  e ? t() : i();
}, _s = ({ autoplayBehavior: e, spinY: t, reversed: i, loopTriggers: s }) => {
  switch (e) {
    case L.SPIN_XY:
    case L.SPIN_YX:
      t ? Le(i, s) : Oe(i, s);
  ...
  const r = s && !o || o && !s ? 0 : n, a = Math.abs(e), l = Math.abs(t);
  return s && a - r > l ? i ? e > 0 ? "left" : "right" : e > 0 ? "right" : "left" : o && l - r > a ? i ? t > 0 ? "up" : "down" : t > 0 ? "down" : "up" : null;
}, js = () => "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0, Us = (e, t = 150) => {
  let i;
  return function(...s) {
...
}, $s = () => document.fullscreenEnabled || document.webkitFullscreenEnabled, oe = () => document.fullscreenElement || document.webkitFullscreenElement, Ks = (e) => e.requestFullscreen ? e.requestFullscreen() : e.webkitRequestFullscreen ? e.webkitRequestFullscreen() : Promise.reject(new Error("Fullscreen API not supported")), He = () => document.exitFullscreen ? document.exitFullscreen() : document.webkitExitFullscreen ? document.webkitExitFullscreen() : Promise.reject(new Error("Fullscreen API not supported")), F = 1;
class qs {
  constructor(t, {
    zoomMax: i = 5,
    zoomStep: s = 0.5,
    ...
    this.container = t, this.zoomMax = i, this.zoomStep = s, this.onZoomChange = o, this.zoom = 1, this.panX = 0, this.panY = 0, this.drawWidth = 0, this.drawHeight = 0, this.isPanning = !1, this.panStartX = 0, this.panStartY = 0, this._onWheel = this._onWheel.bind(this), this._onDblClick = this._onDblClick.bind(this), this._onMouseMove = this._onMouseMove.bind(this), this._onMouseUp = this._onMouseUp.bind(this), this._onGestureStart = this._onGestureStart.bind(this), this._onGestureChange = this._onGestureChange.bind(this), this._onGestureEnd = this._onGestureEnd.bind(this), this._gestureBaseZoom = 1, this._attach();
  }
  setDrawSize(t, i, s = !1) {
    const o = this.drawWidth, n = this.drawHeight;
    this.drawWidth = t, this.drawHeight = i, s && o && n ? (this.panX = this.panX / o * t, this.panY = this.panY / n * i, this._clampPan()) : (this.panX = t / 2, this.panY = i / 2);
  }
  _attach() {
  ...
  zoomTowardPoint(t, i, s) {
    this._zoomTowardPoint(t, i, s);
  }
  getZoom() {
    return this.zoom;
  }
  ...
  _onMouseMove(t) {
    ...
    const i = t.pageX - this.panStartX, s = t.pageY - this.panStartY;
    this.panStartX = t.pageX, this.panStartY = t.pageY, this._applyPan(this.panX - i, this.panY - s);
  }
  _onMouseUp() {
  ...
  _onWheel(t) {
    ...
    const s = Math.pow(2, i / 300), o = this.zoom * s;
  ...
  handleKeyPan(t, i = 50) {
    ...
    return this._applyPan(this.panX + s, this.panY + o), !0;
  }
  ...
  // --- Internal ---
  _zoomTowardPoint(t, i, s) {
    var r;
    const o = Math.max(F, Math.min(t, this.zoomMax));
    if (o === this.zoom) return;
    const n = (r = this.container.querySelector("canvas")) == null ? void 0 : r.getBoundingClientRect();
    if (n) {
      const a = (i - n.left) / n.width * this.drawWidth, l = (s - n.top) / n.height * this.drawHeight, h = o / this.zoom;
      this.panX = a + (this.panX - a) * h, this.panY = l + (this.panY - l) * h;
    }
    this.zoom = o, this._clampPan(), this._emit();
  }
  _applyZoom(t) {
...
class Js {
  constructor(t, {
    ...
    this.container = t, this.onPinchZoom = i, this.onPan = s, this.onDoubleTap = o, this.getZoom = n, this.zoomMax = r, this.isPinching = !1, this.initialPinchDistance = 0, this.pinchBaseZoom = 1, this.lastTouchX = 0, this.lastTouchY = 0, this.lastTapTime = 0, this.lastTapX = 0, this.lastTapY = 0, this._onTouchStart = this._onTouchStart.bind(this), this._onTouchMove = this._onTouchMove.bind(this), this._onTouchEnd = this._onTouchEnd.bind(this), this._attach();
  }
  _attach() {
  ...
  _onTouchStart(t) {
    if (t.touches) {
      ...
      if (t.touches.length === 1) {
        ...
        const s = Date.now(), o = s - this.lastTapTime, n = Math.abs(i.pageX - this.lastTapX), r = Math.abs(i.pageY - this.lastTapY);
        if (o < 300 && n < 30 && r < 30) {
        ...
        this.lastTapTime = s, this.lastTapX = i.pageX, this.lastTapY = i.pageY;
      }
    }
  }
  _onTouchMove(t) {
    if (t.touches) {
      if (this.isPinching && t.touches.length === 2) {
        ...
        const s = i / this.initialPinchDistance, o = Math.max(1, Math.min(this.pinchBaseZoom * s, this.zoomMax)), n = (t.touches[0].clientX + t.touches[1].clientX) / 2, r = (t.touches[0].clientY + t.touches[1].clientY) / 2;
        typeof this.onPinchZoom == "function" && this.onPinchZoom(o, n, r);
        return;
      }
      if (t.touches.length === 1) {
        if ((typeof this.getZoom == "function" ? this.getZoom() : 1) <= 1) return;
        t.preventDefault();
        const s = t.touches[0], o = s.pageX - this.lastTouchX, n = s.pageY - this.lastTouchY;
        this.lastTouchX = s.pageX, this.lastTouchY = s.pageY, typeof this.onPan == "function" && this.onPan(o, n);
      }
    }
  }
  _onTouchEnd(t) {
...
const Qs = '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="11" cy="11" r="8"/><line x1="21" x2="16.65" y1="21" y2="16.65"/><line x1="11" x2="11" y1="8" y2="14"/><line x1="8" x2="14" y1="11" y2="11"/></svg>', to = '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="11" cy="11" r="8"/><line x1="21" x2="16.65" y1="21" y2="16.65"/><line x1="8" x2="14" y1="11" y2="11"/></svg>', eo = '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg>', io = (e, {
  ...
  a.className = "cloudimage-360-zoom-btn cloudimage-360-zoom-btn-in", a.setAttribute("aria-label", "Zoom in"), a.innerHTML = Qs, a.addEventListener("click", (p) => {
    p.stopPropagation(), typeof i == "function" && i();
  });
  const l = document.createElement("button");
  l.className = "cloudimage-360-zoom-btn cloudimage-360-zoom-btn-out", l.setAttribute("aria-label", "Zoom out"), l.innerHTML = to, l.disabled = !0, l.addEventListener("click", (p) => {
    p.stopPropagation(), typeof s == "function" && s();
  });
  const h = document.createElement("button");
  h.className = "cloudimage-360-zoom-btn cloudimage-360-zoom-btn-reset", h.setAttribute("aria-label", "Reset zoom"), h.innerHTML = eo, h.disabled = !0, h.addEventListener("click", (p) => {
...
class no {
  ...
  drawImageOnCanvas(t = {}, i = 1, s = 0, o = 0) {
    ...
    if (this.wideImage ? (r = 0, a = (this.canvas.height / this.dpr - this.drawHeight) / 2) : (r = (this.canvas.width / this.dpr - this.drawWidth) / 2, a = 0), this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height), i !== 1) {
      const { naturalWidth: l, naturalHeight: h } = t, { zoomedWidth: c, zoomedHeight: p } = Bs(l, h, i), { zoomOffsetX: m, zoomOffsetY: u } = Gs({
        pointerX: s,
        pointerY: o,
        imageData: t,
        zoomedWidth: c,
...
const ro = /* @__PURE__ */ new Set([
  ...
  const i = (s) => {
    if (Array.from(s.childNodes).forEach(i), s.nodeType === Node.ELEMENT_NODE) {
      ...
      if (Array.from(s.attributes).forEach((l) => {
        ...
        let c = l.value;
        ao.forEach((p) => {
          p.test(c) && s.removeAttribute(l.name);
        });
      }), n === "a") {
...
}, ho = (e) => e === "y" ? O.Y : O.X, co = (e, t, i) => e.filter((s) => t in s.positions ? i === "grid" ? !0 : ho(s.orientation) === i : !1), uo = (e, t, i) => {
  ...
  const s = document.createElement("div");
  return s.className = "cloudimage-360-popper", s.id = `cloudimage-360-popper-${t}`, s.dataset.popperId = t, s.setAttribute("role", "tooltip"), s.setAttribute("aria-hidden", "false"), typeof e == "string" && /<\/?[a-z][\s\S]*>/i.test(e) ? s.innerHTML = lo(e) : s.textContent = e, (i || document.body).appendChild(s), s;
}, go = (e) => e.map((t) => {
  const i = { ...po(t.positions) };
  ...
  let l = e, h = t, c = 0, p = 0;
  const m = e / t;
  s > m ? (h = e / s, p = (t - h) / 2) : (l = t * s, c = (e - l) / 2);
  const I = n ? 1 : l / r, g = n ? 1 : h / a;
  return o.map((v) => {
    const y = {};
    return Object.entries(v.initialPositions).forEach(([k, b]) => {
      n ? y[k] = {
        x: b.x / 100 * l + c,
        y: b.y / 100 * h + p
      } : y[k] = {
...
function yo(e) {
  ...
  if (e.title && i.push(`<h3 class="ci360-popper-title">${pt(e.title)}</h3>`), e.originalPrice || e.price) {
    let s = "";
    e.originalPrice && (s += `<span class="ci360-popper-original-price">${pt(e.originalPrice)}</span>`), e.price && (s += `<span class="ci360-popper-price">${pt(e.price)}</span>`), i.push(`<div class="ci360-popper-price-row">${s}</div>`);
  }
  if (e.description && i.push(`<p class="ci360-popper-description">${pt(e.description)}</p>`), e.url && bo(e.url)) {
    const s = e.ctaText || "View details", o = e.id ? ` data-product-id="${kt(e.id)}"` : "";
    i.push(
      `<a class="ci360-popper-cta" href="${kt(e.url)}" target="_top"${o}>${pt(String(s))}</a>`
    );
  } else if (e.id) {
    const s = e.ctaText || "View details";
    i.push(
      `<button class="ci360-popper-cta" data-product-id="${kt(e.id)}">${pt(String(s))}</button>`
    );
  }
  return i.length > 0 && t.push(`<div class="ci360-popper-body">${i.join("")}</div>`), t.join("");
}
function xt(e) {
  return e.content ? e.content : e.data ? yo(e.data) : "";
}
function pt(e) {
...
var R = "top", G = "bottom", _ = "right", z = "left", ae = "auto", Lt = [R, G, _, z], mt = "start", At = "end", wo = "clippingParents", si = "viewport", Et = "popper", Co = "reference", Ze = /* @__PURE__ */ Lt.reduce(function(e, t) {
  return e.concat([t + "-" + mt, t + "-" + At]);
}, []), oi = /* @__PURE__ */ [].concat(Lt, [ae]).reduce(function(e, t) {
  return e.concat([t, t + "-" + mt, t + "-" + At]);
}, []), Io = "beforeRead", xo = "read", ko = "afterRead", Eo = "beforeMain", Po = "main", To = "afterMain", So = "beforeWrite", Ao = "write", Xo = "afterWrite", Lo = [Io, xo, ko, Eo, Po, To, So, Ao, Xo];
function V(e) {
...
function Oo(e) {
  ...
  Object.keys(t.elements).forEach(function(i) {
    ...
    !B(n) || !V(n) || (Object.assign(n.style, s), Object.keys(o).forEach(function(r) {
      var a = o[r];
...
function Yo(e) {
  ...
  return Object.assign(t.elements.popper.style, i.popper), t.styles = i, t.elements.arrow && Object.assign(t.elements.arrow.style, i.arrow), function() {
    Object.keys(t.elements).forEach(function(s) {
      var o = t.elements[s], n = t.attributes[s] || {}, r = Object.keys(t.styles.hasOwnProperty(s) ? t.styles[s] : i[s]), a = r.reduce(function(l, h) {
        return l[h] = "", l;
      }, {});
      !B(o) || !V(o) || (Object.assign(o.style, a), Object.keys(n).forEach(function(l) {
        o.removeAttribute(l);
      }));
    });
  };
...
function gt(e, t, i) {
  ...
  t && B(e) && (o = e.offsetWidth > 0 && ft(s.width) / e.offsetWidth || 1, n = e.offsetHeight > 0 && ft(s.height) / e.offsetHeight || 1);
  var r = rt(e) ? D(e) : window, a = r.visualViewport, l = !ni() && i, h = (s.left + (l && a ? a.offsetLeft : 0)) / o, c = (s.top + (l && a ? a.offsetTop : 0)) / n, p = s.width / o, m = s.height / n;
  return {
    width: p,
    height: m,
    top: c,
...
function he(e) {
  var t = gt(e), i = e.offsetWidth, s = e.offsetHeight;
...
function Ro(e) {
  ...
  var o = Kt(e);
  for (le(o) && (o = o.host); B(o) && ["html", "body"].indexOf(V(o)) < 0; ) {
    var n = J(o);
...
function Ot(e) {
  for (var t = D(e), i = De(e); i && Ho(i) && J(i).position === "static"; )
    i = De(i);
  return i && (V(i) === "html" || V(i) === "body" && J(i).position === "static") ? t : i || Ro(e) || t;
}
function ce(e) {
...
function Do(e) {
  var t, i = e.state, s = e.name, o = e.options, n = i.elements.arrow, r = i.modifiersData.popperOffsets, a = W(i.placement), l = ce(a), h = [z, _].indexOf(a) >= 0, c = h ? "height" : "width";
  if (!(!n || !r)) {
    var p = Zo(o.padding, i), m = he(n), u = l === "y" ? R : z, I = l === "y" ? G : _, g = i.rects.reference[c] + i.rects.reference[l] - r[l] - i.rects.popper[c], v = r[l] - i.rects.reference[l], y = Ot(n), k = y ? l === "y" ? y.clientHeight || 0 : y.clientWidth || 0 : 0, b = g / 2 - v / 2, w = p[u], E = k - m[c] - p[I], f = k / 2 - m[c] / 2 + b, C = Tt(w, f, E), x = l;
    i.modifiersData[s] = (t = {}, t[x] = C, t.centerOffset = C - f, t);
  }
}
function Bo(e) {
  var t = e.state, i = e.options, s = i.element, o = s === void 0 ? "[data-popper-arrow]" : s;
  o != null && (typeof o == "string" && (o = t.elements.popper.querySelector(o), !o) || ri(t.elements.popper, o) && (t.elements.arrow = o));
}
const Go = {
  name: "arrow",
  enabled: !0,
...
function Be(e) {
  var t, i = e.popper, s = e.popperRect, o = e.placement, n = e.variation, r = e.offsets, a = e.position, l = e.gpuAcceleration, h = e.adaptive, c = e.roundOffsets, p = e.isFixed, m = r.x, u = m === void 0 ? 0 : m, I = r.y, g = I === void 0 ? 0 : I, v = typeof c == "function" ? c({
    x: u,
    y: g
  }) : {
    x: u,
  ...
  u = v.x, g = v.y;
  var y = r.hasOwnProperty("x"), k = r.hasOwnProperty("y"), b = z, w = R, E = window;
  if (h) {
    var f = Ot(i), C = "clientHeight", x = "clientWidth";
    if (f === D(i) && (f = it(i), J(f).position !== "static" && a === "absolute" && (C = "scrollHeight", x = "scrollWidth")), f = f, o === R || (o === z || o === _) && n === At) {
      w = G;
      var P = p && f === E && E.visualViewport ? E.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        f[C]
      );
      g -= P - s.height, g *= l ? 1 : -1;
    }
    if (o === z || (o === R || o === G) && n === At) {
      b = _;
      var S = p && f === E && E.visualViewport ? E.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        f[x]
      );
      u -= S - s.width, u *= l ? 1 : -1;
  ...
  if (u = M.x, g = M.y, l) {
    var Y;
    return Object.assign({}, A, (Y = {}, Y[w] = k ? "0" : "", Y[b] = y ? "0" : "", Y.transform = (E.devicePixelRatio || 1) <= 1 ? "translate(" + u + "px, " + g + "px)" : "translate3d(" + u + "px, " + g + "px, 0)", Y));
  }
  return Object.assign({}, A, (t = {}, t[w] = k ? g + "px" : "", t[b] = y ? u + "px" : "", t.transform = "", t));
}
function No(e) {
  var t = e.state, i = e.options, s = i.gpuAcceleration, o = s === void 0 ? !0 : s, n = i.adaptive, r = n === void 0 ? !0 : n, a = i.roundOffsets, l = a === void 0 ? !0 : a, h = {
...
function Vo(e) {
  var t = e.state, i = e.instance, s = e.options, o = s.scroll, n = o === void 0 ? !0 : o, r = s.resize, a = r === void 0 ? !0 : r, l = D(t.elements.popper), h = [].concat(t.scrollParents.reference, t.scrollParents.popper);
...
function de(e) {
  var t = D(e), i = t.pageXOffset, s = t.pageYOffset;
  return {
    scrollLeft: i,
    scrollTop: s
  };
...
function Ko(e, t) {
  var i = D(e), s = it(e), o = i.visualViewport, n = s.clientWidth, r = s.clientHeight, a = 0, l = 0;
  if (o) {
...
function qo(e) {
  var t, i = it(e), s = de(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, n = nt(i.scrollWidth, i.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), r = nt(i.scrollHeight, i.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), a = -s.scrollLeft + ue(e), l = -s.scrollTop;
  return J(o || i).direction === "rtl" && (a += nt(i.clientWidth, o ? o.clientWidth : 0) - n), {
    width: n,
    height: r,
    x: a,
    y: l
...
function St(e, t) {
  var i;
  t === void 0 && (t = []);
  var s = ci(e), o = s === ((i = e.ownerDocument) == null ? void 0 : i.body), n = D(s), r = o ? [n].concat(n.visualViewport || [], pe(s) ? s : []) : s, a = t.concat(r);
  return o ? a : (
...
function _e(e, t, i) {
  return t === si ? re(Ko(e, i)) : rt(t) ? Jo(t, i) : re(qo(it(e)));
}
function Qo(e) {
  var t = St(Kt(e)), i = ["absolute", "fixed"].indexOf(J(e).position) >= 0, s = i && B(e) ? Ot(e) : e;
  return rt(s) ? t.filter(function(o) {
    return rt(o) && ri(o, s) && V(o) !== "body";
  }) : [];
}
function tn(e, t, i, s) {
  var o = t === "clippingParents" ? Qo(e) : [].concat(t), n = [].concat(o, [i]), r = n[0], a = n.reduce(function(l, h) {
    var c = _e(e, h, s);
...
function di(e) {
  var t = e.reference, i = e.element, s = e.placement, o = s ? W(s) : null, n = s ? vt(s) : null, r = t.x + t.width / 2 - i.width / 2, a = t.y + t.height / 2 - i.height / 2, l;
  switch (o) {
    case R:
      l = {
        x: r,
...
function Xt(e, t) {
  t === void 0 && (t = {});
  var i = t, s = i.placement, o = s === void 0 ? e.placement : s, n = i.strategy, r = n === void 0 ? e.strategy : n, a = i.boundary, l = a === void 0 ? wo : a, h = i.rootBoundary, c = h === void 0 ? si : h, p = i.elementContext, m = p === void 0 ? Et : p, u = i.altBoundary, I = u === void 0 ? !1 : u, g = i.padding, v = g === void 0 ? 0 : g, y = li(typeof v != "number" ? v : hi(v, Lt)), k = m === Et ? Co : Et, b = e.rects.popper, w = e.elements[I ? k : m], E = tn(rt(w) ? w : w.contextElement || it(e.elements.popper), l, c, r), f = gt(e.elements.reference), C = di({
    reference: f,
    element: b,
    placement: o
  }), x = re(Object.assign({}, b, C)), P = m === Et ? x : f, S = {
...
function en(e, t) {
  t === void 0 && (t = {});
  var i = t, s = i.placement, o = i.boundary, n = i.rootBoundary, r = i.padding, a = i.flipVariations, l = i.allowedAutoPlacements, h = l === void 0 ? oi : l, c = vt(s), p = c ? a ? Ze : Ze.filter(function(I) {
    return vt(I) === c;
...
function on(e) {
  ...
  if (!t.modifiersData[s]._skip) {
    for (var o = i.mainAxis, n = o === void 0 ? !0 : o, r = i.altAxis, a = r === void 0 ? !0 : r, l = i.fallbackPlacements, h = i.padding, c = i.boundary, p = i.rootBoundary, m = i.altBoundary, u = i.flipVariations, I = u === void 0 ? !0 : u, g = i.allowedAutoPlacements, v = t.options.placement, y = W(v), k = y === v, b = l || (k || !I ? [Vt(v)] : sn(v)), w = [v].concat(b).reduce(function(tt, N) {
    ...
    }, []), E = t.rects.reference, f = t.rects.popper, C = /* @__PURE__ */ new Map(), x = !0, P = w[0], S = 0; S < w.length; S++) {
      var A = w[S], M = W(A), Y = vt(A) === mt, j = [R, G].indexOf(M) >= 0, U = j ? "width" : "height", H = Xt(t, {
        placement: A,
        boundary: c,
        rootBoundary: p,
        altBoundary: m,
...
function rn(e) {
  var t = e.state, i = e.name, s = t.rects.reference, o = t.rects.popper, n = t.modifiersData.preventOverflow, r = Xt(t, {
    elementContext: "reference"
  }), a = Xt(t, {
    altBoundary: !0
  }), l = Fe(r, s), h = Fe(a, o, n), c = Ne(l), p = Ne(h);
  t.modifiersData[i] = {
...
function ln(e, t, i) {
  var s = W(e), o = [z, R].indexOf(s) >= 0 ? -1 : 1, n = typeof i == "function" ? i(Object.assign({}, t, {
    placement: e
  })) : i, r = n[0], a = n[1];
  return r = r || 0, a = (a || 0) * o, [z, _].indexOf(s) >= 0 ? {
    x: a,
    y: r
  } : {
    x: r,
...
function hn(e) {
  var t = e.state, i = e.options, s = e.name, o = i.offset, n = o === void 0 ? [0, 0] : o, r = oi.reduce(function(c, p) {
    return c[p] = ln(p, t.rects, n), c;
  }, {}), a = r[t.placement], l = a.x, h = a.y;
  t.modifiersData.popperOffsets != null && (t.modifiersData.popperOffsets.x += l, t.modifiersData.popperOffsets.y += h), t.modifiersData[s] = r;
}
const cn = {
  name: "offset",
  enabled: !0,
...
function mn(e) {
  var t = e.state, i = e.options, s = e.name, o = i.mainAxis, n = o === void 0 ? !0 : o, r = i.altAxis, a = r === void 0 ? !1 : r, l = i.boundary, h = i.rootBoundary, c = i.altBoundary, p = i.padding, m = i.tether, u = m === void 0 ? !0 : m, I = i.tetherOffset, g = I === void 0 ? 0 : I, v = Xt(t, {
    boundary: l,
    rootBoundary: h,
    padding: p,
    altBoundary: c
  }), y = W(t.placement), k = vt(t.placement), b = !k, w = ce(y), E = pn(w), f = t.modifiersData.popperOffsets, C = t.rects.reference, x = t.rects.popper, P = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, S = typeof P == "number" ? {
    mainAxis: P,
    altAxis: P
  ...
  if (f) {
    if (n) {
      var Y, j = w === "y" ? R : z, U = w === "y" ? G : _, H = w === "y" ? "height" : "width", Z = f[w], at = Z + v[j], $ = Z - v[U], lt = u ? -x[H] / 2 : 0, ht = k === mt ? C[H] : x[H], st = k === mt ? -x[H] : -C[H], Q = t.elements.arrow, tt = u && Q ? he(Q) : {
        width: 0,
        height: 0
      }, N = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ai(), ot = N[j], ct = N[U], K = Tt(0, C[H], tt[H]), yt = b ? C[H] / 2 - lt - K - ot - S.mainAxis : ht - K - ot - S.mainAxis, qt = b ? -C[H] / 2 + lt + K + ct + S.mainAxis : st + K + ct + S.mainAxis, bt = t.elements.arrow && Ot(t.elements.arrow), Jt = bt ? w === "y" ? bt.clientTop || 0 : bt.clientLeft || 0 : 0, Yt = (Y = A == null ? void 0 : A[w]) != null ? Y : 0, Qt = Z + yt - Yt - Jt, te = Z + qt - Yt, Mt = Tt(u ? $t(at, Qt) : at, Z, u ? nt($, te) : $);
      f[w] = Mt, M[w] = Mt - Z;
    }
    if (a) {
      var wt, Ht = w === "x" ? R : z, Rt = w === "x" ? G : _, q = f[E], dt = E === "y" ? "height" : "width", zt = q + v[Ht], Zt = q - v[Rt], Ct = [R, z].indexOf(y) !== -1, Dt = (wt = A == null ? void 0 : A[E]) != null ? wt : 0, Bt = Ct ? zt : q - C[dt] - x[dt] - Dt + S.altAxis, Gt = Ct ? q + C[dt] + x[dt] - Dt - S.altAxis : Zt, _t = u && Ct ? zo(Bt, q, Gt) : Tt(u ? Bt : zt, q, u ? Gt : Zt);
      f[E] = _t, M[E] = _t - q;
    }
    t.modifiersData[s] = M;
  }
...
function bn(e, t, i) {
  i === void 0 && (i = !1);
  var s = B(t), o = B(t) && yn(t), n = it(t), r = gt(e, o, i), a = {
    scrollLeft: 0,
    scrollTop: 0
  }, l = {
    x: 0,
  ...
  return (s || !s && !i) && ((V(t) !== "body" || // https://github.com/popperjs/popper-core/issues/1078
...
function kn(e) {
  e === void 0 && (e = {});
  var t = e, i = t.defaultModifiers, s = i === void 0 ? [] : i, o = t.defaultOptions, n = o === void 0 ? We : o;
  return function(a, l, h) {
    ...
    var c = {
      ...
      setOptions: function(y) {
        ...
        g(), c.options = Object.assign({}, n, c.options, k), c.scrollParents = {
          reference: rt(a) ? St(a) : a.contextElement ? St(a.contextElement) : [],
          popper: St(l)
        };
        var b = Cn(xn([].concat(s, c.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!m) {
          var y = c.elements, k = y.reference, b = y.popper;
          if (Ve(k, b)) {
            c.rects = {
              reference: bn(k, Ot(b), c.options.strategy === "fixed"),
              popper: he(b)
            ...
            for (var w = 0; w < c.orderedModifiers.length; w++) {
              ...
              var E = c.orderedModifiers[w], f = E.fn, C = E.options, x = C === void 0 ? {} : C, P = E.name;
    ...
    function I() {
      c.orderedModifiers.forEach(function(v) {
        var y = v.name, k = v.options, b = k === void 0 ? {} : k, w = v.effect;
...
var En = [jo, un, Wo, Mo, cn, nn, fn, Go, an], Pn = /* @__PURE__ */ kn({
  defaultModifiers: En
});
...
class Sn {
  ...
  constructor(t, i, s, o = {}) {
    ge(this, "updateHotspotPosition", (t, i) => {
      ...
      const s = co(this.hotspotsConfig, t, i);
      this.hideHotspots(), s.forEach((o) => this.updateAndShowHotspot(o, t));
    });
    this.container = i, this.popper = null, this.popperInstance = null, this.hotspotsContainer = Is(this.container), this.hotspotsConfig = go(t), this.shouldHidePopper = !0, this.hidePopper = this.hidePopper.bind(this), this.forceHidePopper = this.forceHidePopper.bind(this), this.imageAspectRatio = s, this.popperListeners = [], this.trigger = o.trigger || "hover", this.onOpen = o.onOpen || null, this.onClose = o.onClose || null, this.onProductClick = o.onProductClick || null, this.onNavigate = o.onNavigate || null;
    const { containerSize: n } = t[0];
    t.some((a) => {
      const l = a.containerSize;
      return n ? l ? l[0] !== n[0] || l[1] !== n[1] : !0 : !!l;
    }) && console.warn(
      "[ci360] All hotspots must use the same containerSize value. Only the first hotspot's containerSize is used."
    ), this.usePercentages = !n, this.initialContainerSize = n || [i.offsetWidth, i.offsetHeight], this.initHotspots(), this.updateHotspotsForResize(i.offsetWidth, i.offsetHeight), this.observeContainerResize();
  }
  ...
  showPopper({ hotspotElement: t, content: i, id: s, keepOpen: o }) {
    ...
    const n = mo(this.container);
    this.popper = fo(i, s, this.container.parentElement), this.currentHotspotElement = t, t.setAttribute("aria-expanded", "true"), t.setAttribute("aria-describedby", `cloudimage-360-popper-${s}`);
    const r = () => {
    ...
    try {
      (p = this.onOpen) == null || p.call(this, s);
    } catch (m) {
  ...
  hidePopper() {
    ...
    const t = (s = this.popperInstance) == null ? void 0 : s.instanceId;
  ...
  createHotspot(t) {
    const { id: i, keepOpen: s, onClick: o, label: n, markerStyle: r, markerTheme: a, className: l, navigateTo: h, arrowDirection: c } = t, p = typeof h == "string" ? h.trim() : void 0, m = xt(t), u = uo(i, n, r);
    if (l && u.classList.add(...l.split(/\s+/).filter(Boolean)), a === "inverted" ? u.classList.add("ci360-hotspot-marker--theme-inverted") : a === "brand" && u.classList.add("ci360-hotspot-marker--theme-brand"), p) {
      if (u.classList.add("cloudimage-360-hotspot--navigate"), u.innerHTML = Tn, c != null && Number.isFinite(c)) {
        const y = u.querySelector(".ci360-navigate-icon");
        y && (y.style.transform = `rotate(${c}deg)`);
      }
      const I = n || p;
      ...
      u.onclick = (y) => {
        y.stopPropagation(), v();
      }, u.addEventListener("keydown", (y) => {
        (y.key === "Enter" || y.key === " ") && (y.preventDefault(), v());
      }), this.hotspotsContainer.appendChild(u);
      return;
    }
    (o || m && this.trigger === "click") && (u.style.cursor = "pointer"), u.onclick = (I) => {
      var g;
      I.stopPropagation(), m && this.trigger === "click" && (((g = this.popperInstance) == null ? void 0 : g.instanceId) === i ? this.hidePopper() : this.showPopper({ hotspotElement: u, content: m, id: i, keepOpen: s })), o == null || o(I, this.popperInstance, i);
    }, m && this.trigger === "hover" && (u.addEventListener(
      "mouseenter",
      () => this.showPopper({ hotspotElement: u, content: m, id: i, keepOpen: s })
    ), u.addEventListener("mouseleave", () => {
      this.shouldHidePopper = !0, this.checkAndHidePopper();
    }), u.addEventListener(
      "focus",
  ...
  updateAndShowHotspot(t, i) {
    const { positions: s, id: o } = t, { x: n, y: r } = s[i] ?? {}, a = this.hotspotsContainer.querySelector(`[data-hotspot-id="${o}"]`);
  ...
  showHotspotById(t) {
    ...
    if (!i) return;
    const s = typeof i.navigateTo == "string" && i.navigateTo.trim(), o = s ? xt(i) || (i.label ? xt({ data: { title: i.label } }) : "") : xt(i);
    if (!o) return;
...
class Ue {
  constructor(t, i) {
    ...
    this.devicePixelRatio = je ? Math.min(s, 2) : s, this.id = t.id, this.movementStart = { x: 0, y: 0 }, this.draggingDirection = null, this.isReady = !1, this.velocityX = 0, this.velocityY = 0, this.lastDragTime = 0, this.lastDragX = 0, this.lastDragY = 0, this.inertiaAnimationId = null, this.hasInteracted = !1, this.touchDevice = js(), this.dragJustEnded = !1, this.zoomPan = null, this.gestureRecognizer = null, this.zoomControlsUI = null, this.scrollHintUI = null, this.highResLoaded = !1, this.useMainThreadCanvas = je, this.canvasWorker = this.useMainThreadCanvas ? new no() : new oo(), this.hotspotTimeline = null, this.hotspotTimelineIndicator = null, this.isAnimatingToFrame = !1, this.onMoveHandler = this.onMoveHandler.bind(this), this.destroy = this.destroy.bind(this), this.init(this.container, i);
  }
  /**
  ...
  mouseDown(t) {
    ...
    if (this.hideHints(), this.hideHotspotPopper(), this.inertiaAnimationId && (cancelAnimationFrame(this.inertiaAnimationId), this.inertiaAnimationId = null), this.autoplayJustStopped = !1, (this.autoplay || this.loopTimeoutId) && (this.stopAutoplay(), this.autoplay = !1, this.autoplayJustStopped = !0), this.isZoomed && this.zoomPan) {
      this.zoomPan.startPan(s, o);
      return;
    }
    this.movementStart = { x: s, y: o }, this.isClicked = !0, this.isDragging = !1, this.inertia && (this.velocityX = 0, this.velocityY = 0, this.lastDragTime = performance.now(), this.lastDragX = s, this.lastDragY = o);
  }
  mouseUp() {
  ...
  startInertia() {
    const s = this.dragSpeed / Ce, o = s * (this.amountX / this.container.offsetWidth), n = s * (this.amountY / this.container.offsetHeight), r = () => {
      ...
      if (h) {
        const c = this.allowSpinX ? Math.max(1, Math.abs(Math.round(a * o))) : 0, p = this.allowSpinY ? Math.max(1, Math.abs(Math.round(l * n))) : 0;
  ...
  drag(t, i) {
    ...
    const n = this.dragSpeed / Ce, r = n * (this.amountX / this.container.offsetWidth), a = n * (this.amountY / this.container.offsetHeight), l = this.allowSpinX ? Math.abs(Math.round(s * r)) : 0, h = this.allowSpinY ? Math.abs(Math.round(o * a)) : 0;
  ...
  getDrawDimensions() {
    ...
    const t = this.canvas.clientWidth, i = t / this.imageAspectRatio, s = t / i;
    return this.imageAspectRatio > s ? { drawWidth: t, drawHeight: t / this.imageAspectRatio } : { drawWidth: i * this.imageAspectRatio, drawHeight: i };
  }
  initZoom() {
    const t = this.zoomMax || 5, i = this.zoomStep || 0.5;
    this.zoomPan = new qs(this.innerBox, {
      zoomMax: t,
      zoomStep: i,
      onZoomChange: (o, n, r) => this.onZoomChange(o, n, r)
    });
    const s = this.getDrawDimensions();
    s && this.zoomPan.setDrawSize(s.drawWidth, s.drawHeight), this.touchDevice && this.pinchZoom !== !1 && (this.gestureRecognizer = new Js(this.innerBox, {
      zoomMax: t,
      getZoom: () => this.zoomPan ? this.zoomPan.getZoom() : 1,
      onPinchZoom: (o, n, r) => {
        this.zoomPan && (n !== void 0 ? this.zoomPan.zoomTowardPoint(o, n, r) : this.zoomPan.applyTouchZoom(o));
      },
      onPan: (o, n) => {
        this.zoomPan && this.zoomPan.applyTouchPan(o, n);
      },
      onDoubleTap: (o, n) => {
        this.zoomPan && (this.zoomPan.isZoomed() ? this.zoomPan.resetZoom() : this.zoomPan.zoomTowardPoint(2, o, n));
      }
    })), this.zoomControls && !this.touchDevice && (this.zoomControlsUI = io(this.innerBox, {
  ...
  onZoomChange(t, i, s) {
    ...
    const o = this.isZoomed;
    if (this.isZoomed = t > 1, this.isZoomed && !o) {
    ...
    !this.isZoomed && o && (this.showAllIcons(), this.emit("onZoomOut"), this.announce("Zoomed out")), this.zoomControlsUI && this.zoomControlsUI.updateState(t), this.updateView(t, i, s);
  }
  removeZoom() {
  ...
  touchMove(t) {
    ...
    t.preventDefault(), this.drag(i, s);
  }
  keyDown(t) {
    if (!this.isReady) return;
    const i = t.target && t.target.tagName;
    if (i === "INPUT" || i === "TEXTAREA" || t.target && t.target.isContentEditable) return;
    const { keyCode: s } = t, o = this.keysReverse;
    if (this.autoplay && this.stopAutoplay(), this.zoomPan && this.zoomPan.handleKeyZoom(s)) {
      t.preventDefault(), this.hideHints();
      return;
    }
    if (this.isZoomed && this.zoomPan && this.zoomPan.handleKeyPan(s, ts)) {
      t.preventDefault();
      return;
    }
    switch (Ye(s, this.allowSpinY) && (this.hasInteracted = !0, this.hideAllIcons(), this.hideHints()), s) {
      case 37:
  ...
  moveRight(t, i = 1) {
    const s = this.isGridMode ? this.amountX - 1 : this.imagesX.length - 1;
    t && this.activeImageX >= s || (this.moveActiveXIndexUp(i), this.isZoomed || this.updateView());
  }
  moveLeft(t, i = 1) {
    t && this.activeImageX <= 0 || (this.moveActiveXIndexDown(i), this.isZoomed || this.updateView());
  }
  moveTop(t, i = 1) {
    const s = this.isGridMode ? this.amountY - 1 : this.imagesY.length - 1;
    t && this.activeImageY >= s || (this.moveActiveYIndexUp(i), this.isZoomed || this.updateView());
  }
  moveBottom(t, i = 1) {
    t && this.activeImageY <= 0 || (this.moveActiveYIndexDown(i), this.isZoomed || this.updateView());
  }
  onMoveHandler(t, i = 1, s = 1) {
    t === "right" ? this.moveRight(this.stopAtEdgesX, i) : t === "left" ? this.moveLeft(this.stopAtEdgesX, i) : t === "up" ? this.moveTop(this.stopAtEdgesY, s) : t === "down" && this.moveBottom(this.stopAtEdgesY, s), this.emit("onSpin", {
      direction: t,
  ...
  updateView(t, i, s) {
    ...
    if (this.isGridMode) {
      ...
      o = this.orientation === O.X ? this.imagesX[this.activeImageX] : this.imagesY[this.activeImageY];
    ...
    this.hotspotsInstance && !this.isZoomed && !this.autoplay && this.hotspotsInstance.updateHotspotPosition(n, this.isGridMode ? "grid" : this.orientation), this.hotspotTimelineIndicator && (this.isGridMode || this.orientation === O.X) && this.updateHotspotTimelinePosition(), this.drawImageOnCanvas(o, t, i, s);
  }
  ...
  adaptCanvasSize(t) {
    ...
    const o = this.canvas.clientWidth, n = o / this.imageAspectRatio;
  ...
  pushImageToSet(t, i, s) {
    s === "grid" ? this.imagesGrid[i] = t : s === O.X ? this.imagesX[i] = t : this.imagesY[i] = t;
  }
  calculatePercentage() {
    if (this.isGridMode) {
      const s = this.amountX * this.amountY, o = this.imagesGrid.filter(Boolean).length;
  ...
  setupResizeObserver() {
    ...
    this.resizeObserver = new ResizeObserver((i) => {
      const s = i[0];
      if (!s) return;
      const o = Math.round(s.contentRect.width);
      o === t || o === 0 || (t = o, requestAnimationFrame(() => {
        let n;
  ...
  onAllImagesLoaded() {
    if (this.addAllIcons(), this.isReady = !0, this.isGridMode || (this.amountX = this.imagesX.length, this.amountY = this.imagesY.length), this.activeImageX = this.autoplayReverse ? this.amountX - 1 : 0, this.activeImageY = this.autoplayReverse ? this.amountY - 1 : 0, this.hotspots)
      if (this.hotspotsInstance = new Sn(this.hotspots, this.innerBox, this.imageAspectRatio, {
    ...
    if (this.emit("onLoad", {
      ...
      t && t.length > 0 && (this.hintsOverlay = Pe(this.innerBox, t), Se(this.hintsOverlay));
    }
    this.autoplay && (this.hideAllIcons(), Us(this.play.bind(this))());
  }
  toggleFullscreen(t) {
    t.stopPropagation(), this.hideHotspotPopper(), oe() ? He() : Ks(this.container);
  }
  onFullscreenChange() {
    const t = oe() === this.container, i = this.container.classList.contains("cloudimage-360--fullscreen");
    t !== i && (this.container.classList.toggle("cloudimage-360--fullscreen", t), ys(this.fullscreenIcon, t), t ? (this.emit("onFullscreenOpen"), this.announce("Opened fullscreen mode. Press Escape to exit.")) : (this.emit("onFullscreenClose"), this.announce("Exited fullscreen mode")));
  }
  play() {
    ...
    let t;
    if (this.isGridMode) {
      const o = this.autoplayBehavior;
      o === "spin-x" ? t = this.amountX : o === "spin-y" ? t = this.amountY : t = Math.max(this.amountX, this.amountY);
    } else
      t = this.amountX + this.amountY;
    const i = this.speed * 36 / t, s = {
    ...
    this.loopTimeoutId = window.setInterval(() => {
      ...
      }) && (this.spinDirection = Vs(this.spinDirection));
  ...
  gridAutoplayTick(t) {
    const i = this.autoplayReverse, s = this.autoplayBehavior;
    if (s === "spin-x") {
      i ? t.left() : t.right();
      return;
    }
    ...
    if (s === "spin-xy") {
      const o = i ? 0 : this.amountX - 1, n = this.activeImageX === o;
    ...
    if (s === "spin-yx") {
      const o = i ? 0 : this.amountY - 1, n = this.activeImageY === o;
  ...
  addFullscreenIcon() {
    !this.fullscreen || !$s() || (this.fullscreenIcon = vs(), this.fullscreenIcon.onclick = this.toggleFullscreen.bind(this), this.iconsContainer.appendChild(this.fullscreenIcon));
  }
  showFullscreenIcon() {
  ...
  add360ViewCircleIcon() {
    this.view360CircleIcon || (this.view360CircleIcon = us(this.bottomCircleOffset), this.innerBox.appendChild(this.view360CircleIcon));
  }
  ...
  addLoadingSpinner() {
    this.loadingSpinner = Cs(), this.innerBox.appendChild(this.loadingSpinner);
  }
  showLoadingSpinner() {
  ...
  hideHints() {
    !this.hintsOverlay || this.hintsHidden || (this.hintsHidden = !0, Ts(this.hintsOverlay));
  }
  addHotspotTimeline() {
    if (!this.hotspots || this.hotspotTimeline) return;
    const t = this.isGridMode ? this.amountX * this.amountY : this.amountX, i = Os(this.innerBox, t, this.hotspots);
    if (!i) return;
    this.hotspotTimeline = i.element, this.hotspotTimelineIndicator = i.indicator, this.innerBox.classList.add("has-hotspot-timeline"), this.hotspotTimeline.querySelectorAll(".cloudimage-360-hotspot-timeline-dot").forEach((o) => {
      o.addEventListener("click", (n) => {
        n.stopPropagation(), this.hideAllIcons(), this.hideHints();
        const r = parseInt(o.getAttribute("data-frame"), 10), a = o.getAttribute("data-hotspot-id");
  ...
  hideHotspotTimeline() {
    Ms(this.hotspotTimeline);
  }
  updateHotspotTimelinePosition() {
    if (this.isGridMode) {
      const t = this.activeImageY * this.amountX + this.activeImageX;
      Ae(this.hotspotTimelineIndicator, t, this.amountX * this.amountY);
    } else
      Ae(this.hotspotTimelineIndicator, this.activeImageX, this.amountX);
  }
  /**
  ...
  animateToFrame(t, i) {
    ...
    const s = this.isGridMode ? this.activeImageY * this.amountX + this.activeImageX : this.activeImageX;
    if (this.isAnimatingToFrame || t === s) {
      t === s && i && this.hotspotsInstance && this.hotspotTimelineOnClick && this.hotspotsInstance.showHotspotById(i);
      return;
    }
    ...
    const o = this.activeImageX, n = (t - o + this.amountX) % this.amountX, r = (o - t + this.amountX) % this.amountX, a = n <= r, l = a ? n : r;
    if (l === 0) {
  ...
  attachEvents(t, i, s) {
    t && this.addMouseEvents(), i && this.addTouchEvents(), s && this.addKeyboardEvents(), this.addEscKeyHandler(), this.addFullscreenChangeHandler();
  }
  removeEvents() {
  ...
  createContainers(t) {
    if (this.iconsContainer = Ee(this.innerBox), this.canvas = fs(this.innerBox, t), this.loader = ws(this.innerBox), this.ariaLiveRegion = xs(this.innerBox), this.useMainThreadCanvas)
      this.canvasWorker.postMessage({
        action: "initCanvas",
  ...
  init(t, i, s) {
    const o = i ? ss(i) : es(t), {
      ...
      onNavigate: Ii,
      onError: xi
    } = o, ee = { ciToken: at, ciFilters: $, ciTransformation: lt, cropAspectRatio: Zt, cropGravity: Ct }, me = Wt(c, []), fe = Wt(p, []);
    let ut = Wt(m, []);
    ut.length && Array.isArray(ut[0]) && (ut = ut.flat()), this.isGridMode = !!(h || ut.length);
    const ki = o.zoomMax === 5 && M > 1 ? Math.min(M, 5) : Y || 5;
    if (this.viewerConfig = o, this.amountX = me.length || I, this.amountY = fe.length || g, this.allowSpinX = !!this.amountX, this.allowSpinY = !!this.amountY, this.isGridMode && (this.allowSpinX = !0, this.allowSpinY = !0), this.orientation = this.allowSpinX ? O.X : O.Y, this.activeImageX = P ? this.amountX - 1 : 0, this.activeImageY = P ? this.amountY - 1 : 0, this.bottomCircleOffset = w, this.autoplay = E, this.autoplayBehavior = f, this.playOnce = C, this.speed = x, this.autoplayReverse = P, this.fullscreen = S, this.zoomMax = ki, this.zoomStep = j || 0.5, this.zoomControls = U ?? !0, this.zoomControlsPosition = H || "bottom-left", this.scrollHint = Z ?? !0, this.dragSpeed = Math.max(st, Qi), this.stopAtEdges = Q, this.stopAtEdgesX = tt ?? Q, this.stopAtEdgesY = N ?? Q, this.ciParams = ee, this.apiVersion = r, this.keysReverse = b, this.info = ot, this.keys = k, this.innerBox = this.innerBox ?? bs(this.container), this.container.style.aspectRatio = zt || "", this.initialIconShown = ct, this.bottomCircle = K, this.spinDirection = Ws(this.autoplayBehavior, this.allowSpinX, this.allowSpinY), this.dragReverse = bt, this.hotspots = yt, this.hotspotTrigger = qt, this.onHotspotOpen = bi, this.onHotspotClose = wi, this.onProductClick = Ci, this.onNavigate = Ii, this.hide360Logo = Jt, this.logoSrc = Yt, this.inertia = Qt, this.pinchZoom = te, this.hints = Mt, this.hotspotTimelineOnClick = dt, wt === "dark" ? this.container.classList.add("ci360-theme-dark") : wt === "light" && this.container.classList.remove("ci360-theme-dark"), this.container.classList.remove("ci360-hotspot-marker-inverted", "ci360-hotspot-marker-brand"), Ht === "inverted" ? this.container.classList.add("ci360-hotspot-marker-inverted") : Ht === "brand" && this.container.classList.add("ci360-hotspot-marker-brand"), Rt ? this.container.style.setProperty("--ci360-hotspot-brand-color", Rt) : this.container.style.removeProperty("--ci360-hotspot-brand-color"), this.onReady = Dt, this.onLoad = Bt, this.onSpin = Gt, this.onAutoplayStart = _t, this.onAutoplayStop = ui, this.onFullscreenOpen = pi, this.onFullscreenClose = mi, this.onZoomIn = fi, this.onZoomOut = gi, this.onDragStart = vi, this.onDragEnd = yi, this.onError = xi, this.srcXConfig = {
      folder: n,
      filename: a,
      imageList: me,
      container: t,
      ...
      indexZeroBase: u,
      autoplayReverse: P
    }, s && this.removeEvents(), s) {
      this.attachEvents(v, y, k);
      return;
    }
    if (q) {
      this.showInitOnClickPreview(v, y, k);
      return;
    }
    this.attachEvents(v, y, k), this.startLoadingImages();
  }
  showInitOnClickPreview(t, i, s) {
    const o = this.isGridMode ? this.srcGridConfig : this.allowSpinX ? this.srcXConfig : this.srcYConfig, n = this.container.offsetWidth, r = o.imageList.length ? null : et(o, n), [a] = o.imageList, l = a || (r ? ei(r, o.indexZeroBase) : null);
    if (!l) return;
    const h = new Image();
    h.className = "cloudimage-360-init-preview", h.alt = "360° view preview — click to load", h.style.cssText = `
      ...
      object-fit: contain;
      object-position: center;
    `, h.src = l, this.innerBox.appendChild(h), this.clickOverlay = ms(this.logoSrc), this.innerBox.appendChild(this.clickOverlay), this.clickOverlayHandler = () => {
      this.clickOverlay.removeEventListener("click", this.clickOverlayHandler), Pt(this.innerBox, ".cloudimage-360-click-overlay"), Pt(this.innerBox, ".cloudimage-360-init-preview"), this.clickOverlay = null, this.clickOverlayHandler = null, this.attachEvents(t, i, s), this.startLoadingImages();
    }, this.clickOverlay.addEventListener("click", this.clickOverlayHandler);
  }
  startLoadingImages() {
    const t = this.container.offsetWidth;
    if (this.isGridMode) {
      const i = this.srcGridConfig.imageList.length ? null : et(this.srcGridConfig, t), s = (o) => {
        ke({
          cdnPath: i,
          config: this.srcGridConfig,
          onImageLoad: (n, r) => {
          ...
          onFirstImageLoad: (n) => this.onFirstImageLoaded(o, n),
          onAllImagesLoad: (n, r) => {
      ...
      se(i, this.srcGridConfig, s);
    } else {
      const i = this.allowSpinX && !this.srcXConfig.imageList.length ? et(this.srcXConfig, t) : null, s = this.allowSpinY && !this.srcYConfig.imageList.length ? et(this.srcYConfig, t) : null, o = (n) => {
        xe({
          cdnPathX: i,
          cdnPathY: s,
          configX: this.srcXConfig,
      ...
      this.allowSpinX ? se(i, this.srcXConfig, o) : this.allowSpinY && se(s, this.srcYConfig, o);
    }
  }
}
...
class Xn {
  ...
  init(t, i) {
    ...
    t.id || (t.id = s);
    const o = new Ue(t, i);
    return this.views.set(s, o), $e && !this.memoryManagementAutoEnabled && (this.memoryManagementAutoEnabled = !0, setTimeout(() => this.enableMemoryManagement(), 100)), o;
  }
      ...
      document.hidden ? this.views.forEach((s) => {
        ...
        if (s.isMemoryReleased) {
          ...
          if (n) {
            ...
            r.top < window.innerHeight && r.bottom > 0 && s.reloadImages();
          }
        }
      });
...
//# sourceMappingURL=ci360-w1B4zAH5.mjs.map
